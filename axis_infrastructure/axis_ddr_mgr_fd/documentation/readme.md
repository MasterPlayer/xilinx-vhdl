...
Параметризуемый компонент для реализации возможности записи/чтения потока с памятью по шине AXI-Stream. Сама память работает на основе AXI-FULL
...
---------|-----|-------------------|---------
ADDR_WIDTH | integer | >0 | Размер шины данных AXI-Stream
DATA_WIDTH | boolean | "true" или "false" | Асинхронный режим
BURST_LIMIT | integer | 0 - 2^31 | Предел таймаута
